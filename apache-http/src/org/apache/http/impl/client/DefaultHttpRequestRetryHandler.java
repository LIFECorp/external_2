...
public class DefaultHttpRequestRetryHandler implements HttpRequestRetryHandler {
    ...
    ///M: Support configure retry count API
    ...
    public boolean retryRequest(
        ...
        if (exception instanceof InterruptedIOException) {
            ...
            //return true;
            // Rollback to Google Default at 2014.02.18 for 3rd party app
            return false;
        }
    ...
    ///M: Support configure retry count API @{    
    /**
     * configure the maximum number of times a method will be retried
     * @hiden
     */
