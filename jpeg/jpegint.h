...
#if 1 //def SKIA_MT_LIBJPEG_TILE_DECODE  
  unsigned int my_struct_size ;
  
  JSAMPARRAY mtk_mt_buffer[MAX_COMPONENTS];
  unsigned int mtk_mt_bufSize[MAX_COMPONENTS];
  
  unsigned int mtk_mt_bufRowNumber[MAX_COMPONENTS];
  unsigned int mtk_mt_bufStride[MAX_COMPONENTS];
#endif  
};
...
struct jpeg_d_coef_controller {
  ...
  JBLOCKROW mtk_mt_MCU_buffer[D_MAX_BLOCKS_IN_MCU];
#endif  
};
...
#if 1 //def SKIA_MT_LIBJPEG_TILE_DECODE
  unsigned int my_struct_size ;
  unsigned char* mtk_mt_colorBuffer[MAX_COMPONENTS];
  unsigned int mtk_mt_colorBufSize[MAX_COMPONENTS];
  
  unsigned int mtk_mt_colorBufRowNumber[MAX_COMPONENTS];
  unsigned int mtk_mt_colorBufStride[MAX_COMPONENTS];  
  JSAMPROW mtk_colorBufRowPtr[4][32];
#endif  
};
