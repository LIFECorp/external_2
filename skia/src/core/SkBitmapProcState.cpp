...
#undef S32_D32_FILTER_DX_SHADERPROC
#define S32_D32_FILTER_DX_SHADERPROC(image0, image1,fx, maxX, subY, colors, dx, count) \
S32_Opaque_D32_filter_DX_shaderproc_neon(image0, image1,fx, maxX, subY, colors, dx, count)
...
#undef S32_D32_FILTER_DX_SHADERPROC
#define S32_D32_FILTER_DX_SHADERPROC(image0, image1,fx, maxX, subY, colors, dx, count) \
S32_alpha_D32_filter_DX_shaderproc_neon(image0, image1,fx, maxX, subY, colors, dx, count, alphaScale)

#include "S32_alpha_D32_filter_DX_shaderproc_neon.cpp"
#define S32_OPAQUE_D32_FILTER_DX_NEON
#include "SkBitmapProcState_shaderproc.h"
#undef S32_OPAQUE_D32_FILTER_DX_NEON
#endif //ARM_HAVE_NEON
