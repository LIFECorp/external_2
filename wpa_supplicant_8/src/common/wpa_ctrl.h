...
/* parameters: <peer UUID> <peer address> */
#define WPS_EVENT_ER_ENROLLEE_ADD_PBC "WPS-ER-ENROLLEE-ADD-PBC "
...
/** P2P NFC device found */
#define P2P_EVENT_NFC_DEVICE_FOUND "P2P-NFC-DEVICE-FOUND "
#define P2P_EVENT_NFC_GO_INVITED "P2P-NFC-GO-INVITED "
...
#define P2P_GO_IP_ALLOCATE "P2P-GO-IP-ALLOCATE"
#define P2P_GC_IP_GET "P2P-GC-IP-GET"
#endif
