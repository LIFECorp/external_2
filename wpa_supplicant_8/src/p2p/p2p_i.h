...
#define P2P_DEV_WITH_NFC BIT(31)
...
#endif
#ifdef CONFIG_MTK_P2P_NFC
	struct wpabuf *p2p_nfc_peer_pw_token; /*Save peer's nfc pw token information */
	int p2p_nfc_local_type;
	u16 p2p_nfc_dev_pw_id;
	int p2p_nfc_handover;
	int p2p_nfc_select_token;	
#endif /* CONFIG_MTK_P2P_NFC */
};
