			     ...
			     struct wpa_eapol_ie_parse *ie)
{
	...
	if (pos[1] > RSN_SELECTOR_LEN + 2 &&
		RSN_SELECTOR_GET(pos + 2) == RSN_KEY_DATA_IP_ALLOC) {
		ie->ip_alloc = pos + 2 + RSN_SELECTOR_LEN;
		ie->ip_alloc_len = pos[1] - RSN_SELECTOR_LEN;
		wpa_hexdump(MSG_DEBUG, "WPA: IP ALLOC in EAPOL-Key",
