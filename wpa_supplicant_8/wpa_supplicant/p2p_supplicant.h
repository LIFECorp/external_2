...
#define P2P_NFC_TYPE_REQ					0x01
#define P2P_NFC_TYPE_SEL					0x02
/* ndef.c */
struct wpabuf * ndef_parse_wifi_p2p(const struct wpabuf *buf);
struct wpabuf * ndef_build_wifi_p2p(const struct wpabuf *buf);
int p2p_add_device_nfc(struct wpa_supplicant *wpa_s, struct p2p_data *p2p, const struct wpabuf *p2p_nfc);
